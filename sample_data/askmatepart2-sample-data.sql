...
-- -- INSERT INTO users VALUES (0,'dan','dan','2017-04-28 08:29:00',1,1,2,1000);
-- --
-- -- INSERT INTO users VALUES (1,'ion','ion','2018-04-28 08:29:00',2,1,0,30);
-- --
...
ALTER TABLE question_tag ADD CONSTRAINT fk_question_id
 FOREIGN KEY (question_id)
 REFERENCES question(id)
 ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE question DROP CONSTRAINT fk_user_id;

ALTER TABLE question ADD CONSTRAINT fk_user_id
 FOREIGN KEY (user_id)
 REFERENCES users(id)
 ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE answer DROP CONSTRAINT fk_user_id;
...
ALTER TABLE comment DROP CONSTRAINT fk_user_id;
...
ALTER TABLE question_tag DROP CONSTRAINT fk_tag_id;
